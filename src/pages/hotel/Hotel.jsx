        ...
        <div className="hotel__container">
          <div className="hotel__wrapper">
            ...
            <div className="hotel__address">
              ...
              <span className='hotel__distance'>Excellent location - 500m from center 
              </span>
              <span className='hotel__price-highlight'>Book a stay over $114 at this propertyu and get a free airport taxi
              </span>
